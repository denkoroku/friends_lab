...
def test_add_friend
  result = add_friend(@person2, "Scrappy-Doo").count
  ...
  def test_delete_friend
    result = delete_friend(@person2, "Velma")
...
def test_total_money
  ...
  def test_loan
    result = loan(@person1, @person2, 20)
    assert_equal( -19, @person1[:monies])
    assert_equal(22, @person2[:monies])
  end
...
def test_all_favourite_food
  ...
  assert_equal(["Scooby snacks", "bread", "charcuterie", "ratatouille", "soup", "spaghetti", "spinach"], result)
end
